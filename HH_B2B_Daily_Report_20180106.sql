...
set closep ','
begin
  create_b2b_daily_rpt_fix('2018-1-6');
end;
/
...
ITEM_POS_SIV||','||ITEM_POS_SEV||','||ITEM_POS_MARGIN||','||UNIT_DIS_SEV||','||ITEM_POS_BG||','||COUP_ITEM_SIV||','||COUP_ITEM_SEV from VW_B2B_DAILY_REPORT_0106
where tran_date=to_date('2018-1-6','yyyy-mm-dd');
spool off;
exit;